...
# How far back to look. The workflow runs every 3 hours; 4 gives an hour of
# overlap so a slow VOD or a late run cannot leave a gap.
WINDOW_H = float(os.environ.get("WINDOW_HOURS", "4"))
